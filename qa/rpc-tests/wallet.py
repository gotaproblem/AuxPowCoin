...
class WalletTest (MincoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 APC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 APC in block rewards plus fees, but
        ...
        # Send 100 APC with subtract fee from amount
        ...
        # Sendmany 10 APC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/apcoin/apcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
