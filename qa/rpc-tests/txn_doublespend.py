...
class TxnMallTest(MincoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 APC:
        ...
        # First: use raw transaction API to send 1240 APC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 APC coin each
        ...
        # Node0's balance should be starting balance, plus 50APC for another
        ...
        # Node0's total balance should be starting balance, plus 100APC for 
