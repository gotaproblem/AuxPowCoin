...
#ifndef APCOIN_QT_APCOINUNITS_H
#define APCOIN_QT_APCOINUNITS_H
...
/** Apcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ApcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ApcoinUnits(QObject *parent);

    /** Apcoin units.
      @note Source: https://en.apcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        APC,
...
typedef ApcoinUnits::Unit ApcoinUnit;

#endif // APCOIN_QT_APCOINUNITS_H
