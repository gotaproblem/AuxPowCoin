...
#define BOOST_TEST_MODULE Apcoin Test Suite

#include "test_apcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_apcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
