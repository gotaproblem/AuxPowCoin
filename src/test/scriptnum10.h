...
#ifndef APCOIN_TEST_SCRIPTNUM10_H
#define APCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Apcoin Core 0.10.0, for cross-comparison.
 */
public:
